...
if (empty($_POST['enunciado']) || empty($_POST['respuesta1']) || empty($_POST['dificultad']) || empty($_POST['lenguaje']) || empty($_POST['tema'])){
    $response['error'] = true;
    ...
    if ($db->addQuestion_completar($enunciado, $respuesta1, $dificultad, $lenguaje, $tema)) {
