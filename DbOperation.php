...
public function plantillaescribir($lenguaje, $tema) {
    ...
    try {
        ...
        $sql = "SELECT ee.*, re.*
                ...
                LEFT JOIN respuestas_escribir re ON ee.id_enunciado_escribir = re.enunciado_id
        ...
        if ($resultado) {
            ...
            // Incluye la columna "correccion" en el array de respuesta
            $response['correccion'] = $resultado['correccion'];
        } else {
            $response['error'] = true;
            $response['message'] = 'No se encontraron enunciados para el tema y lenguaje especificados.';
        }
